 ...
 * Human input validator and Computer selection creator class
 * @author Dom Hemphill
 * @version 1.0
 */
public class RPSLSpock {

    // not sure how this calculates a random
    ...
    /**
     * Determines if user has made a valid selection
     * @param pick
    ...
    /**
     * Determines if the computer won or not
     * @param c_pick
     * @param h_pick
     * @return true or false
     */
    public static boolean isComputerWin(String c_pick,String h_pick) {
        // why didn't c pick have to .toLowerCase?
